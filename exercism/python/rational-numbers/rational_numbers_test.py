...
class RationalNumbersTest(unittest.TestCase):
    ...
    # def test_new(self):
    #     print(Rational(10,52))
    #     print(Rational(16,52))
    #     print(Rational(90,240))
    #     print(Rational(44,1))
    #     print(Rational(21,96))
    #     print(Rational(256,60))
    #     print(Rational(144,84))
    #     print(Rational(81,72))
    #     print(Rational(60,100))
    #     print(Rational(64,20))
    #     print(Rational(64,37))
        # rational = Rational(100000, 37)
        # print(rational)
    ...
    def test_add_zero(self):
        self.assertEqual(Rational(-1, 2) + Rational(0, 3), Rational(1, -2))
